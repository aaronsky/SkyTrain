...
Model::Model(std::string objName, ID3D11Device * device) : Mesh()
{
	LoadModel(objName, device);
}
...
void Model::LoadModel(std::string objName, ID3D11Device * device)
{
	// File input object
	std::ifstream obj(objName); // <-- Replace filename with your parameter
